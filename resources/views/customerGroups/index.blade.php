            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('customer-groups.create') }}" class="btn btn-success" title="Create"><i class="fa fa-plus"></i> Add Data</a>
                        @endcan
                    </div>
                </div>
            </div>
...
@push('js')
    <script>
        ...
        @can('customer_groups_delete')
            let deleteButton = {
                text: 'Delete selected',
                url: "{{ route('customer-groups.massDestroy') }}",
